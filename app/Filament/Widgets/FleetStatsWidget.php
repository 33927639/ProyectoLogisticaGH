...
{
    protected static ?string $pollingInterval = '60s'; // ESTADÍSTICO: Actualizar cada 60s
    ...
    protected function getStats(): array
    {
        ...
        // Cache por 30 segundos para optimizar rendimiento
        return Cache::remember('fleet_stats', 30, function () {
